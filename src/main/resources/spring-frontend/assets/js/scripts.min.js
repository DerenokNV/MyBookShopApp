            ...
            return {
                init: function () {
                    $('[data-refreshshow]').on('click change', function (e) {
                        ...
                        /*getData('/books/recent/page', {  from: '01.01.2020',
                                                   to: '01.01.2023',
                                                   offset: 0,
                        ...
                        switch (data) {
                            ...
                            case'popular':
                                ...
                                break;
                            case'genre':
                                getData('/genres/slug/page/' + $this.data('refreshquery'), {
                                    //offset: $this.data('refreshoffset'),
                                    offset: function () {
                                        var oldOffset = $this.data('refreshoffset');
                                        if(oldOffset < 1){
                                ...
                                break;
                            case'author':
                                getData('/books/author/page/' + $this.data('refreshquery'), {
                                    offset: function () {
                                      var oldOffset = $this.data('refreshoffset');
                                      if(oldOffset < 1){
                                        $this.data('refreshoffset', ++oldOffset);
                                ...
                                break;
                            case'tag':
                                //getData('/books/tag/page' + $this.data('refreshid'), {
                                getData('/books/tag/page/' + $this.data('refreshquery'), {
                                    offset: function () {
                                                                          var oldOffset = $this.data('refreshoffset');
                                                                            if(oldOffset < 1){
                                                                              $this.data('refreshoffset', ++oldOffset);
            ...
            return {
                init: function () {
                    ...
                    $('.Comments-addComment form').on('submit', function (e) {
                        ...
                        if (!error) {
                            Login().postData('/book/bookReview', {
                    ...
                    $('[data-likeid]').on('click', function (e) {
                        ...
                        Login().postData('/book/rateBookReview', data, function (result) {
            ...
            return {
                init: function () {
                    ...
                    $ProductAssesment.find('.Rating input').on('change', function (e) {
                        ...
                        Login().postData('/book/changeBookStatus/like', {
                                ...
                                if ($(slick.$slides[slick.$slides.length - 3]).hasClass('slick-active')) {
                                    if ($(slick.$slider).data('load')) {
                                        ...
                                        function sendData(address) {
                                          switch (address) {
                                            case '/authors/slug/slider/':
                                                 getData(address + $this.data('refreshquery'), {
                                                    offset: function () {
                                        ...
                                        switch ($(slick.$slider).data('load')) {
                                            case'recommended':
                                                ...
                                                break;
                                            case'recent':
                                                sendData('/books/recent') ///books/recentMain
                                                break;
                                            case'popular':
                                                sendData('/books/popular')///books/popularMain
                                                break;
                                            case'author':
                                                sendData('/authors/slug/slider/')
                                                break;
                                        }
                                    }
                                }
